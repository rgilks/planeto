...
// Graphviz is required to render PNGs from .dot sources. The diagrams CI
// workflow installs it; local machines without `dot` skip with a clear message.
...
const tempDir = mkdtempSync(join(tmpdir(), "planeto-diagrams-"));
